...
- [x] T-P0-SLA-08 完成状态聚合切换到 `ObservabilityService` -> 细化任务见 [SPEC-P1-observability-service](./SPEC-P1-observability-service.md) 第 4 节。
...
- 2026-02-25 增补：新增 `ObservabilityService` 并完成 `/status`、`/search/stats`、`/storage/stats`、Bot `/ping` 统一快照采集改造。
