...
# 开启白名单后，黑名单失效
WHITE_LIST = eval(os.getenv("WHITE_LIST", ()))
BLACK_LIST = eval(os.getenv("BLACK_LIST", ()))
...
# BOT设置
OWNER_IDS = eval(os.getenv("OWNER_IDS", [123456789]))
...
#MAX_PAGE = 10
# 是否开启消息缓存
SEARCH_CACHE = bool(os.getenv("SEARCH_CACHE", True))
