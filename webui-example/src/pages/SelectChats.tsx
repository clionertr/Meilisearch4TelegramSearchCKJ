        ...
        <div className="bg-background-light dark:bg-background-dark min-h-screen flex flex-col text-slate-900 dark:text-white">
            <header className="flex items-center justify-between px-4 py-3 sticky top-0 z-30 bg-background-light dark:bg-background-dark">
                ...
                <div className="flex-1 flex justify-end px-2">
                    <button type="button" onClick={selectAll} className="focus-ring text-sm font-semibold text-primary hover:opacity-80 transition-opacity">
                        {selected.size === dialogs.length ? t('selectChats.deselectAll') : t('selectChats.selectAll')}
                    </button>
                </div>
            </header>
                                ...
                                <div className="flex items-center gap-3 overflow-hidden">
                                    ...
                                    <div className="flex flex-col truncate">
                                        ...
                                        <div className="flex items-center gap-1.5 text-xs text-slate-500 dark:text-slate-400">
                                            {dialog.message_count !== null && <span>{t('selectChats.messagesCount', { count: dialog.message_count.toLocaleString() })}</span>}
