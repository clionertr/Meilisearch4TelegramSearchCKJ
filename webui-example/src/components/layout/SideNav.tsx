...
const SideNav: React.FC = () => {
  ...
  return (
    <nav
      ...
      className="hidden md:flex md:h-screen md:w-64 md:flex-col md:border-r md:border-slate-200 md:bg-white/70 md:backdrop-blur md:dark:border-white/5 md:dark:bg-background-dark/50"
    >
