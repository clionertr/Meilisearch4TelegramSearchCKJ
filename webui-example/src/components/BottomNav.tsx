...
const BottomNav: React.FC = () => {
  ...
  return (
    <nav
      ...
      className="fixed bottom-0 left-0 right-0 mx-auto max-w-md border-t border-slate-200 bg-white/85 px-6 pt-3 pb-8 backdrop-blur-xl dark:border-white/5 dark:bg-background-dark/85 md:hidden"
    >
